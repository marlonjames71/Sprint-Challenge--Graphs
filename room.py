...
class Room:
    ...
    def connect_rooms(self, direction, connecting_room):
        ...
        self.direct_connections[direction] = connecting_room.id
        self.id_connections[connecting_room.id] = direction
    ...
    # Refactor from O(n) to O(1) -> Have to modify class a bit
    def direction_for_room(self, room_id):
        return self.id_connections[room_id]
